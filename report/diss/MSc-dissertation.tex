...
GPUs primarily achieve their massive performance increases over CPUs by harnessing operating in a massively parallel fashion.


\subsection{GPU memory hierarchies}

\section{Current state of the art in FDTD acoustical modelling}

\section{Other Methods}

The methods outlined in this section are described in a deliberately terse way. They do not form the body of the work done for this dissertation and are discussed here purely to offer some justification as to why not.
