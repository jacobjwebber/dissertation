...
where $\textbf{p}$ is the deviation from the ambient air pressure, and $c$ is the speed of sound. This result is derived by, among others, Richard Feynman in \cite{feynman}. It is trivial to generalise this for 3 dimensional systems, which yields
...
\begin{equation}
\Bigg(\nabla \equiv \hat\textbf{i} \frac{\partial }{\partial x} + \hat \textbf{j} \frac{\partial }{\partial y} + \hat \textbf{k} \frac{\partial }{\partial z}\Bigg)
\end{equation}
