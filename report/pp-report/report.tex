...
This dissertation is generally well formatted and easy to read, using the standard EPCC \LaTeX template. However, there is perhaps a little too much information included in the preface, with a full table of contents, table of figures and index of tables. This means that for a document of 69 pages, the actual report does not start until the 14th page.
